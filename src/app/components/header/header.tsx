...
export default function Header() {
  ...
  return (
    <>
      <div
        className={`fixed top-0 right-0 w-[330px] h-full bg-main-bg z-50 ${
          isOpen ? "" : "translate-x-[330px]"
        } duration-300`}
      >
        <div
          className="mx-4 content-center cursor-pointer absolute right-2 top-12"
          onClick={() => {
            setIsOpen(false);
          }}
        >
        ...
        <div className="w-full mt-[120px] sm:mt-[240px]">
          <div className="mx-6 border-b-[1px] text-center py-3 mt-2">
            <a className="font-semibold text-xl cursor-pointer uppercase font-ivy-mode">
              {" "}
              Building Amenities
            </a>
          </div>
      ...
      <div className="w-full flex h-[100px] bg-main-bg text-center fixed z-30">
        <div className="max-w-[1440px] w-full mx-auto flex justify-between">
          ...
          <div className="w-full flex justify-end">
            ...
            <div
              className="mx-8 content-center cursor-pointer"
              onClick={() => {
                setIsOpen(true);
              }}
            >
